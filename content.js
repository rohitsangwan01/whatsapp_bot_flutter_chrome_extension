  ...
  return (function (e) {
    ...
    function (e, t, n) {
      ...
      var a = n(0),
        ...
        f = i(l),
        c = { tabs: [], config: {} };
      (c._remove = function (e) {
        var t = void 0;
        (t = s.default.searchByKeyName(c.tabs, "id", e.id, "index")),
          c.tabs.splice(t, 1);
      }),
        (c._preProcessMessage = function (e) {
          try {
            e = c.config.stringify(e);
          } catch (e) {
            throw new Error(f.default.INVALID_JSON);
          }
          return (
            e &&
              -1 === e.indexOf(o.default.PARENT_COMMUNICATED) &&
              (e = o.default.PARENT_COMMUNICATED + e),
            e
          );
        }),
        (c.addNew = function (e) {
        ...
        (c.getOpened = function () {
          return c.tabs.filter(function (e) {
            return e.status === d.default.OPEN;
          });
        }),
        (c.getClosed = function () {
          return c.tabs.filter(function (e) {
            return e.status === d.default.CLOSE;
          });
        }),
        (c.getAll = function () {
          return c.tabs;
        ...
        (c.closeTab = function (e) {
          var t = s.default.searchByKeyName(c.tabs, "id", e);
          return t && t.ref && (t.ref.close(), (t.status = d.default.CLOSE)), c;
        }),
        (c.closeAll = function () {
          var e = void 0;
          for (e = 0; e < c.tabs.length; e++)
            c.tabs[e] &&
              c.tabs[e].ref &&
              (c.tabs[e].ref.close(), (c.tabs[e].status = d.default.CLOSE));
          return c;
        }),
        (c.broadCastAll = function (e, t) {
          var n = void 0,
            i = c.getOpened();
          for (e = c._preProcessMessage(e), n = 0; n < i.length; n++)
            c.sendMessage(i[n], e, t);
          return c;
        }),
        (c.broadCastTo = function (e, t, n) {
          var i = void 0,
            a = c.getAll();
          return (
            (t = c._preProcessMessage(t)),
            (i = s.default.searchByKeyName(a, "id", e)),
            c.sendMessage(i, t, n),
            c
          );
        }),
        (c.sendMessage = function (e, t, n) {
          var i = c.config.origin || "*";
          if (n && e.ref[0])
            for (var a = 0; a < e.ref.length; a++) e.ref[a].postMessage(t, i);
    ...
    function (e, t, n) {
      ...
      (i.searchByKeyName = function (e, t, n, i) {
        ...
        for (o = 0; o < e.length; o++) {
          if (
            ((r = e[o]), !isNaN(n) && parseInt(r[t], 10) === parseInt(n, 10))
          ) {
            u = o;
            break;
          }
    ...
    function (e, t, n) {
      ...
      var a = n(7),
        ...
        r = n(12),
        s = i(r),
        u = { Parent: o.default, Child: s.default };
      t.default = u;
    },
    function (e, t, n) {
      "use strict";
      ...
      var o =
        ...
        O = (function () {
          function e(t) {
            a(this, e),
              (t = t || {}),
              void 0 === t.heartBeatInterval && (t.heartBeatInterval = 500),
              void 0 === t.shouldInitImmediately &&
            ...
            r(e, [
              {
                ...
                value: function () {
                  var e = void 0,
                    t = l.default.getAll(),
                    n = l.default.getOpened();
                  if (!n || !n.length)
                    return window.clearInterval(E), (E = null), !1;
              ...
              },
              {
                ...
                value: function (e) {
                  if (!e || !e.ref) return !1;
                  var t = e.ref.closed ? v.default.CLOSE : v.default.OPEN,
                    n = e.status;
                  if (!t || t === n) return !1;
                  n === v.default.OPEN &&
                    t === v.default.CLOSE &&
              ...
              },
              {
                key: "onChildUnload",
                value: function (e) {
                  this.onChildDisconnect && this.onChildDisconnect(e.detail);
                },
              },
              {
              ...
              },
              {
                ...
                value: function () {
                  var e = this;
                  window.removeEventListener("message", y.default.onNewTab),
                    window.addEventListener("message", y.default.onNewTab),
                    ...
                    window.addEventListener("onChildUnload", function (t) {
                      return e.onChildUnload(t);
                    }),
                    (window.onbeforeunload = function () {
                      l.default.broadCastAll(p.default.PARENT_DISCONNECTED);
                    });
                },
              },
              {
                key: "enableElements",
                value: function () {
                  c.default.enable("data-tab-opener");
                },
              },
              {
                key: "getAllTabs",
                value: function () {
                  return l.default.getAll();
                },
              },
              {
                key: "getOpenedTabs",
                value: function () {
                  return l.default.getOpened();
                },
              },
              {
                key: "getClosedTabs",
                value: function () {
                  return l.default.getClosed();
                },
              },
              {
                key: "closeAllTabs",
                value: function () {
                  return l.default.closeAll();
                },
              },
              {
                key: "closeTab",
                value: function (e) {
                  return l.default.closeTab(e);
                },
              },
              {
                key: "broadCastAll",
                value: function (e) {
                  return l.default.broadCastAll(e);
                },
              },
              {
                key: "broadCastTo",
                value: function (e, t) {
                  return l.default.broadCastTo(e, t);
                },
              },
              {
                key: "openNewTab",
                value: function (e) {
                  if (!e) throw new Error(g.default.CONFIG_REQUIRED);
                  if (!e.url) throw new Error(g.default.URL_REQUIRED);
                  return (
                    (m = new this.Tab()),
                    m.create(e),
                    E || this.startPollingTabs(),
                    m
                  );
                },
              },
    ...
    function (e, t, n) {
      ...
      var o =
        ...
        h = (function () {
          function e() {
            a(this, e), (window.name = window.name || "PARENT_TAB");
          }
          return (
            r(e, [
              {
                ...
                value: function (e) {
                  return (
                    ...
                    o(this, e),
                    (this.id =
                      l.default.generate() || u.default.tabs.length + 1),
                    (this.status = "open"),
                    ...
                    c.default.disable("data-tab-opener"),
                    (window.newlyTabOpened = {
                      id: this.id,
                      name: this.name || this.windowName,
                      ref: this.ref,
                    }),
                    u.default.addNew(this),
                    this
                  );
                },
              },
    ...
    function (e, t, n) {
      ...
      n(11);
      var c = {};
      (c._onLoad = function (e) {
        var t = void 0,
          n = void 0,
          i = e.split(f.default.LOADED)[1];
        if (i)
          try {
            (i = s.default.config.parse(i)),
              i.id &&
                ((t = s.default.getAll()),
                t.length &&
            ...
            throw new Error(d.default.INVALID_JSON);
          }
        if (window.newlyTabOpened)
          try {
            (n = f.default.HANDSHAKE_WITH_PARENT),
              (n += s.default.config.stringify({
        ...
        (c._onCustomMessage = function (e, t) {
          var n = void 0,
            i = void 0,
            a = e.split(t)[1];
          try {
            a = s.default.config.parse(a);
          } catch (e) {
            throw new Error(d.default.INVALID_JSON);
          }
          (i = { tabInfo: a, type: t }),
            (n = new CustomEvent("onCustomChildMessage", { detail: i })),
            window.dispatchEvent(n);
        }),
        (c._onBeforeUnload = function (e) {
          var t = void 0,
            n = e.split(f.default.ON_BEFORE_UNLOAD)[1];
          try {
            n = s.default.config.parse(n);
          } catch (e) {
            throw new Error(d.default.INVALID_JSON);
          }
          s.default.tabs.length &&
            ((t = s.default.getAll()),
            (window.newlyTabOpened =
              o.default.searchByKeyName(t, "id", n.id) ||
              window.newlyTabOpened));
          var i = new CustomEvent("onChildUnload", { detail: n });
          window.dispatchEvent(i);
        }),
        (c.onNewTab = function (e) {
          var t = e.data;
          return (
            !(!t || "string" != typeof t || !s.default.tabs.length) &&
            (!s.default.config.origin ||
              s.default.config.origin === e.origin) &&
            void (t.indexOf(f.default.LOADED) > -1
              ? c._onLoad(t)
              : t.indexOf(f.default.CUSTOM) > -1
              ? c._onCustomMessage(t, f.default.CUSTOM)
              : t.indexOf(f.default.HANDSHAKE) > -1
              ? c._onCustomMessage(t, f.default.HANDSHAKE)
              : t.indexOf(f.default.ON_BEFORE_UNLOAD) > -1 &&
                c._onBeforeUnload(t))
          );
        }),
        (t.default = c);
            ...
            r(e, [
              ...
              },
              {
                ...
                value: function (e) {
                  return (
                    !!this.isSessionStorageSupported &&
                    (window.sessionStorage.setItem(this.sessionStorageKey, e),
                    e)
                  );
                },
              },
              ...
              },
              {
                ...
                value: function (e) {
                  ...
                  try {
                    ...
                    throw new Error(l.default.INVALID_DATA);
                  }
                },
              },
              {
                ...
                value: function (e) {
                  ...
                  if (
                    ...
                    if (
                      ...
                      i.indexOf(u.default.PARENT_DISCONNECTED) > -1 &&
                        (this.config.onParentDisconnect &&
                          this.config.onParentDisconnect(),
                        window.removeEventListener("message", function (e) {
                          return t.onCommunication(e);
                        })),
                      i.indexOf(u.default.HANDSHAKE_WITH_PARENT) > -1)
                    ) {
                      var a = void 0;
                      (n = i.split(u.default.HANDSHAKE_WITH_PARENT)[1]),
                        this._setData(n),
                        this._parseData(n),
                        (a = {
                          id: this.tabId,
                        ...
                        this.sendMessageToParent(a, u.default.HANDSHAKE),
                        this.config.onInitialize && this.config.onInitialize();
                    }
                    if (i.indexOf(u.default.PARENT_COMMUNICATED) > -1) {
                      n = i.split(u.default.PARENT_COMMUNICATED)[1];
                      try {
                        n = this.config.parse(n);
                      } catch (e) {
                        throw new Error(l.default.INVALID_JSON);
                      }
              ...
              },
              {
                ...
                value: function () {
                  ...
                  (window.onbeforeunload = function (t) {
                    ...
                    e.sendMessageToParent(n, u.default.ON_BEFORE_UNLOAD);
                  }),
              ...
              },
              {
                ...
                value: function () {
                  ...
                  return window.setTimeout(function () {
                    e.config.onHandShakeExpiry && e.config.onHandShakeExpiry();
              ...
              },
              {
                ...
                value: function (e, t) {
                  var n = void 0;
                  (e = (t || u.default.CUSTOM) + this.config.stringify(e)),
                    window.top.opener &&
    ...
    var __webpack_modules__ = {
        ...
        6139: (e, t, r) => {
          ...
          t.isBlocked = function (e) {
            ...
            return (
              o.ContactStore.get(t) || new o.ContactModel({ id: t })
            ).isBlocked();
          };
        },
        81677: function (e, t, r) {
          ...
          t.unblockContact = async function (e) {
            ...
            return (
              await u.unblockContact(r), { wid: t, isBlocked: r.isBlocked() }
            );
          };
        },
            ...
            (function () {
              function e(e) {
                ...
                const t = e.from,
                  ...
                  n = e.from,
                  o =
                    !e.recipient || u.UserPrefs.getMeUser().equals(e.recipient);
                if (!o) return;
        ...
        41531: (e, t, r) => {
          ...
          t.forwardMessage = async function (e, t, r = {}) {
            ...
            return await i.forwardMessages(
              [s],
              r.multicast,
        ...
        91144: (e, t, r) => {
          ...
          t.getVotes = async function (e) {
            ...
            if (!r.asPollCreation)
              throw new n.WPPError(
                "msg_not_found",
                `Message ${t.toString()} not not a poll`,
                { id: t.toString() }
              );
        ...
        60758: (e, t, r) => {
          ...
          Object.defineProperty(t, "sendReactionToMessage", {
            enumerable: !0,
            get: function () {
              return K.sendReactionToMessage;
            },
          });
          var H = r(16627);
          ...
          Object.defineProperty(t, "sendVCardContactMessage", {
            enumerable: !0,
            get: function () {
              return J.sendVCardContactMessage;
            },
          });
          var Q = r(57709);
        ...
        79824: function (e, t, r) {
          ...
          s.onInjected(() => {
            ...
            s.onInjected(() => {
              ...
              (null == e ? void 0 : e.default) &&
                (window.stylex = null == e ? void 0 : e.default);
            });
        },
        94296: (e, t) => {
          "use strict";
        ...
        38721: function (e, t, r) {
          ...
          const a = r(62275),
            ...
            c = r(65267),
            l = r(13115);
          s(r(13115), t), (t.waVersion = "2.24.7");
        ...
        97046: function (e, t, r) {
          ...
          (t.isInjected = !1),
            ...
            (t.onInjected = function (e) {
              i.internalEv.on("webpack.injected", async () =>
                Promise.resolve()
                  .then(e)
                  .catch(() => null)
              );
                    ...
                    queueMicrotask(() =>
                      (async (e) => {
                        ...
                        const r = new Array(1e4)
                          ...
                          o = (e) => {
                            const r = t.webpackRequire.u(e);
                            for (const e of n) if (e[0].test(r)) return e[1];
                            return 0;
                          },
        ...
        58785: function (e, t, r) {
          ...
          (t._moduleIdMap = l),
            ...
            (t.wrapModuleFunction = function (e, r) {
              ...
              const p = c.reduce((e, t) => (null == e ? void 0 : e[t]), o);
              (p[f] = (0, a.wrapFunction)(e.bind(p), r)),
                l.set(p[f], n),
                d.set(p[f], i);
            });
        },
...
async function onMessage(data) {
  let id = data.id;
  try {
    console.log("Parent communicated: ", data);
    let codeText = data.code;
    let isEvent = data.isEvent;
    if (isEvent) {
      WPP.on(codeText, (data) => {
        sendMessage(id, data, null, true);
      });
    ...
    sendMessage(id, null, err.toString(), false);
  }
}

function sendMessage(id, result, error, isEvent) {
  try {
...
var child = new AcrossTabs.default.Child(config);

console.log("Waiting for WPP to be ready");
WPP.on("webpack.ready", function () {
  console.log("webpack.ready");
  sendMessage("webpack.ready", "webpack.ready");
});
